...
public enum Results implements ErrorMessage {
    ...
    LOGIN_SUC(1002, i18n("RESULT.LOGIN_SUC")),
    LOGIN_FAIL(1003, i18n("RESULT.LOGIN_FAIL")),
    EMAIL_EXIST(1004, i18n("RESULT.EMAIL_EXIST")),
    WISH_EXIST(1005, i18n("RESULT.WISH_EXIST")),
